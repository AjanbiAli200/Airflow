...
from astro.files import File # pyright: ignore[reportMissingImports]
...
@dag(
    ...
    on_success_callback=SlackNotifier(
        slack_conn_id = 'slack',
        text='The Dag stock_market has successeded',
        channel='general'
    ),
...
def stock_market():
    @task.sensor(poke_interval=30, timeout=300, mode='poke') # for 30 secs and 300 is 5 minutes 
